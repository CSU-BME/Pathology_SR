...
class SRGAN(BasicRestorer):
    ...
    def train_step(self, data_batch, optimizer):
        ...
        # fake
        fake_d_pred = self.discriminator(fake_g_output[1].detach() if isinstance(fake_g_output,tuple) else fake_g_output.detach())
        ...
        outputs = dict(
            ...
            results=dict(lq=lq.cpu(), gt=gt.cpu(), output=fake_g_output[1].cpu() if isinstance(fake_g_output,tuple) else fake_g_output.cpu()))
