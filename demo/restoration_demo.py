...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path',default='../configs/restorers/Pathology_MSR/glean_in256out2048_pathology.py')
    parser.add_argument('--checkpoint', help='checkpoint file',default='../pretrained/pretrained_MSR.pth')
    parser.add_argument('--img_path', help='path to input image file',default='../demo_files/XXXXX.jpg')
    parser.add_argument('--save_path', help='path to save restoration result',default='../XXXXX.jpg')
    parser.add_argument(
